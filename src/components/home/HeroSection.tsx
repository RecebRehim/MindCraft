      ...
      <section className="hero-bg relative overflow-hidden">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-6 py-14 lg:grid-cols-2 lg:gap-16 lg:py-20">
          <div className="max-w-xl">
            <h1 className="text-[2.5rem] font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-5xl lg:text-[3.25rem]">
              {h.titleStart}{' '}
            ...
            <p className="mt-6 text-base leading-relaxed text-slate-600 sm:text-lg">{h.subtitle}</p>
            ...
            <div className="mt-14 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
              {stats.map(({ value, labelKey }) => (
                ...
                >
                  ...
                  <p className="mt-1.5 text-[11px] font-medium leading-tight text-slate-500 sm:text-xs">
                    {h.stats[labelKey]}
                  </p>
                </div>
              ))}
